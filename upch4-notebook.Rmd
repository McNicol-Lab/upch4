...
sum(abs(joined_qfr$mean_FCH4P - joined_qfr$FCH4))/length(joined_qfr$mean_FCH4P)
sum(joined_qfr$mean_FCH4P - joined_qfr$FCH4)/length(joined_qfr$mean_FCH4P)
...
sum(abs(joined_alq$mean_FCH4P - joined_alq$FCH4))/length(joined_alq$mean_FCH4P)
sum(joined_alq$mean_FCH4P - joined_alq$FCH4)/length(joined_alq$mean_FCH4P)
