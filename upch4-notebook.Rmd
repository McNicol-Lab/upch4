...
data1 <- data %>% 
  ...
  mutate(FCH4_mc = list(rlaplace(1000, location = FCH4, scale = FCH4_UNC/2)),
         ...
         wc_mtdq_mc = list(rnorm(1000, mean = wc_mtdq, sd = wc_mtdq_sd)),
         wc_pwtm_mc = list(rnorm(1000, mean = wc_pwtm, sd = wc_pwtm_sd)),
         canopyht_mc = list(rnorm(1000, mean = canopyht, sd = canopyht_sd))) %>% 
  unnest(cols = c(FCH4_mc, TA_mc, TA_LAG2_mc, EVI_LAG3_mc, wc_mtdq_mc, wc_pwtm_mc, 
                  canopyht_mc))
```
...
data3 <- data2 %>% bind_rows() %>% dplyr::select(mc_i, everything()) 
```
...
ID.names <- data3 %>% dplyr::select(ID) %>% mutate(ID = factor(ID)) %>% distinct()
...
folds_retained <- list()
for(i in 1:length(cluster.drop)){
...
##### MC Prediction Variance vs. Dissimilarity
...
di %>%
  group_by(Cluster) %>%
  summarize(DI_cluster_mean = mean(DI)) %>%
  arrange(desc(DI_cluster_mean)) %>%
  write.csv(paste0(loc, "dissimilarity/output/stats/mean_cluster_DI.csv"), 
            row.names = F)
```
...
##### Compare grid predictions at individual training sites 
...
###### Read in training site data and get monthly means 

```{r}
train <- readRDS(paste0(loc, "/mc/data/1000mc_500bs.rds")) %>% 
  dplyr::select(ID, Year, Month, Week, FCH4, FCH4_UNC) %>% 
  mutate(ID = paste(substr(ID, 1, 2), substr(ID, 3, 5), sep = "-")) 
...
# join- and remove erroneous RU-COK data above 50 nmol m-2 s-1 
train.pred <- train.monthly %>% left_join(site.pred) %>% 
  dplyr::select(ID, Year, Month, everything()) 
```
```{r}
# bog
train.pred %>% 
  ...
  filter(ID %in% c("BRNpw")) %>%
  ggplot(aes(x = Year_dec)) +
  geom_vline(xintercept = c(2011:2016), color = 'grey70', linetype = 'dashed') +
  geom_ribbon(aes(ymin = mean_FCH4 - sd_FCH4, ymax = mean_FCH4 + sd_FCH4)) + # add observations
  ...
  geom_line(aes(y = mean_FCH4P), size = 0.5, alpha = 0.3) +
  facet_wrap(~ID, ncol= 2, scales = "free") +
  my_theme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_bog.png", sep = ""),
       width = 18, height = 20, units = c("cm"), dpi = 300)
```
...
train.pred %>% 
  ...
  mutate(Month_dec = Month/12,
         Year_dec = Year+Month_dec) %>% 
  filter(ID %in% c("NZ-KOP")) %>%
  ggplot(aes(x = Year_dec)) +
  geom_vline(xintercept = c(2012:2016), color = 'grey70', linetype = 'dashed') +
  geom_ribbon(aes(ymin = mean_FCH4 - sd_FCH4, ymax = mean_FCH4 + sd_FCH4)) + # add observations
  geom_line(aes(y = mean_FCH4), size = 0.5) +
  geom_point(aes(y = mean_FCH4), shape = 21, fill = "white") +
  geom_ribbon(aes(ymin = mean_FCH4P - sd_FCH4P, ymax = mean_FCH4P + sd_FCH4P, fill = factor(member)), alpha = 0.1) + # add predictions
  geom_line(aes(y = mean_FCH4P, color = factor(member)), size = 0.5, alpha = 0.3) +
  facet_wrap(~ID, ncol= 2, scales = "free") +
  scale_color_manual(values = rep(c("dark blue", "dark red"), 4)) +
  scale_fill_manual(values = rep("grey70", 8)) +
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_bog.png", sep = ""),
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_fen.png", sep = ""),
       width = 18, height = 20, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mutate(Month_dec = Month/12,
         Year_dec = Year+Month_dec) %>% 
  filter(ID %in% c("FI-LOM")) %>%
  ggplot(aes(x = Year_dec)) +
  geom_vline(xintercept = c(2006:2011), color = 'grey70', linetype = 'dashed') +
  geom_ribbon(aes(ymin = mean_FCH4 - sd_FCH4, ymax = mean_FCH4 + sd_FCH4)) + # add observations
  geom_line(aes(y = mean_FCH4), size = 0.5) +
  geom_point(aes(y = mean_FCH4), shape = 21, fill = "white") +
  geom_ribbon(aes(ymin = mean_FCH4P - sd_FCH4P, ymax = mean_FCH4P + sd_FCH4P, fill = factor(member)), alpha = 0.1) + # add predictions
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_fen.png", sep = ""),
       width = 12, height = 10, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_marsh.png", sep = ""),
       width = 18, height = 20, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mutate(Month_dec = Month/12,
         Year_dec = Year+Month_dec) %>% 
  filter(ID %in% c("US-MYB")) %>%
  ggplot(aes(x = Year_dec)) +
  geom_vline(xintercept = c(2010:2018), color = 'grey70', linetype = 'dashed') +
  geom_ribbon(aes(ymin = mean_FCH4 - sd_FCH4, ymax = mean_FCH4 + sd_FCH4)) + # add observations
  geom_line(aes(y = mean_FCH4), size = 0.5) +
  geom_point(aes(y = mean_FCH4), shape = 21, fill = "white") +
  geom_ribbon(aes(ymin = mean_FCH4P - sd_FCH4P, ymax = mean_FCH4P + sd_FCH4P, fill = factor(member)), alpha = 0.1) + # add predictions
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_marsh.png", sep = ""),
       width = 12, height = 10, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_wet_tundra.png", sep = ""),
       width = 18, height = 20, units = c("cm"), dpi = 300)

# interesting wet tundra
train.pred %>% 
  group_by(ID) %>% 
  mutate(Month_dec = Month/12,
         Year_dec = Year+Month_dec) %>% 
  filter(ID %in% c("US-IVO")) %>%
  ggplot(aes(x = Year_dec)) +
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_wet_tundra.png", sep = ""),
       width = 12, height = 10, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_swamp.png", sep = ""),
       width = 12, height = 16, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_swamp.png", sep = ""),
       width = 12, height = 10, units = c("cm"), dpi = 300)
...
train.pred %>% 
  ...
  mytheme +
  labs(x= "Year", y = expression(CH[4]*' Flux (nmol m'^{-2}*' s'^{-1}*')')) 
ggsave(paste("/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Predictions/Gridded/nmol_summary/figures/",today,"_interesting_swamp2.png", sep = ""),
       width = 12, height = 10, units = c("cm"), dpi = 300)
