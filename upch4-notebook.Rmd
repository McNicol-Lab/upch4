...
sums_mean <- cellStats(r_mean_stack, sum)
sums_sd <- cellStats(r_sd_stack, sum)
...
write.csv(upscaling_sums, paste0(loc, "predictions/gridded/tg/sums_method1/upscaling_sums.csv"), row.names = F)
write.csv(annual_sums, paste0(loc, "predictions/gridded/tg/sums_method1/annual_sums.csv"), row.names = F)
write.csv(monthly_cycle, paste0(loc, "predictions/gridded/tg/sums_method1/monthly_cycle.csv"), row.names = F)
```

##### Calculate Global Grid Tg Totals
###### (METHOD 2: Mean bootstrap sum and variance)
...
###### (METHOD 3: Individual bootstrap cumsums and variance)
