...
rf_pred <- mclapply(paste(loc, "/ffs/first-pair/rf-pred/rf_pred_", i, ".csv", sep = ""), read.csv)

for(i in 1:4000){
  rf.metrics[[i]] <- read.csv(paste(loc, "/ffs/first-pair/rf-pred/rf_pred_", i, ".csv", sep = "")) %>% 
