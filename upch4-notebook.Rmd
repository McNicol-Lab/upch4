...
# now subset the single site from each mc_i
data8 <- list()
for(i in 1:500){
  data8[[i]] <- data5 %>% 
...
data8 <- bind_rows(data8)

saveRDS(data8, "/Volumes/LACIE SHARE/Stanford CH4/June 2020 Upscaling/Model Datasets/mc/201006_all_ppro_1000mc_500bs_heldout.rds")
