...
data1 <- data %>% 
  rowwise() %>% 
  mutate(FCH4_mc = list(rnorm(10, mean = FCH4, sd = FCH4_F_UNC)),
         TA_mc = list(rnorm(10, mean = TA, sd = 1)),
         TA_LAG2_mc = list(rnorm(10, mean = TA_LAG2, sd = 1)),
         EVI_LAG3_mc = list(rnorm(10, mean = EVI_LAG3, sd = 0.015)),
         wc_mtdq_mc = list(rnorm(10, mean = wc_mtdq, sd = wc_mtdq_sd)),
         wc_pwtm_mc = list(rnorm(10, mean = wc_pwtm, sd = wc_pwtm_sd)),
         canopyht_mc = list(rnorm(10, mean = canopyht, sd = canopyht_sd))) %>% 
