...
col_vector_values <- read.csv(paste(loc, "dissimilarity/figures/color_ramp_constituency.csv", sep = "")) %>% 
...
```
##### Issue with the recaled EVI

Try replacing all NAs with zeros

```{r}
plot(scaled_data_4[[7]])
scaled_data_4[is.na(scaled_data_4)] <- 0
plot(scaled_data_4[[7]])
```
