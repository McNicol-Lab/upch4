...
upscaling %>% 
  ...
  geom_line(aes(Dec_year, `VISIT_ech4`), color = 'grey70', alpha = 0.7) +
    ...
    geom_ribbon(aes(ymin = sums_mean - sums_sd, ymax = sums_mean + sums_sd), fill =  "light pink", alpha = 0.4) + # add observations
    geom_line(color = 'dark red') +
  
    geom_line(aes(Dec_year, ctracker), color = "black") +
