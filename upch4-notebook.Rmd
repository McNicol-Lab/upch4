...
```{r}
sums <- read.csv(paste0(loc, "predictions/gridded/tg/sums_method1/global/annual_sums.csv"))
...
fig6_sums %>% 
  ...
  labs(x = "Reference", y = expression(atop("Global CH"[4]*" Emissions",
                                  "(Tg yr"^{-1}*")"))) +
  scale_color_manual(values = c("#377EB8","black","#E78AC3")) +
  scale_shape_manual(values = c(17, 15, 16)) +
  coord_flip() +
  my_theme
ggsave(paste0(loc, "predictions/gridded/tg/figures/congo_comparison.png"),
       width = 20, height = 10, units = c("cm"), dpi = 300)
