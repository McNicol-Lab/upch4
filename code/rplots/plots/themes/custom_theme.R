...
theme_map <- function(base_size) {
  theme_bw(base_size = base_size) +
    theme(plot.title = element_text(face = 'bold', size = 12, hjust = 0.5),
          ...
          # Panel
          panel.grid.minor = element_blank(), #element_line(color = '#D0D0D0'),
          panel.grid.major = element_blank(), #element_line(color = '#D0D0D0'),
          panel.background = element_blank(), #element_rect(fill = '#F5F5F5', size = 2),
